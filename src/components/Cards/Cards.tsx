...
export function Cards() {
    ...
    return (
        <div className="relative p-4 md:py-20 flex flex-col items-center">
            ...
            <div className="flex justify-around w-full max-w-5xl mx-auto md:grid-cols-2">
                <div className="flex flex-col items-center justify-center">
                    <Reveal>
                        <div className="flex flex-col items-start gap-4">
                            <h1 className="text-4xl font-semibold tracking-wider">DISEÑA TU PROPIA</h1>
                            <h1 className="text-4xl font-semibold tracking-wider">TARJETA CON</h1>
                            <h1 className="text-6xl degradedBlue bg-OrangeLight font-extrabold tracking-wider">THIS NIGHT</h1>
                        </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="mt-4 flex items-center space-x-4">
                        <button
                            ...
                            className='relative inline-block p-px font-semibold leading-6 text-white no-underline bg-slate-950 shadow-2xl cursor-pointer group rounded-xl shadow-zinc-900'
                        >
